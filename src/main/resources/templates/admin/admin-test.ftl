      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item js_clickBtn" date-name="${request.contextPath}/index/admintest" href="#">用户信息</a>
            <a class="collapse-item js_clickBtn" date-name="${request.contextPath}/index/admintable" href="#">博文信息</a>
          </div>
        </div>
      </li>
           ...
           <!--  <div class="topbar-divider d-none d-sm-block"></div> -->
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">用户名</span>
